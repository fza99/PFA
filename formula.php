...
<body>
      ...
      <div class="container">
        ...
        <nav id="nav">
          <ul>
            ...
            <li><a href="twocolumn1.html">Nos servises</a></li>
  ...
  <div class="form_container">
    <div class="title_container">
      <h2>Formulaire de Pré_inscription</h2>
    </div>
    <div class="row clearfix">
      <div class="">
        <form id='register-form' autocomplete="off" method="POST" action="test.php" >
          <div class="row clearfix">
            <div class="col_half">
          ...
          <div class="input_field"> 
            ...
            <input type="text" name="PrenomBebe" placeholder="PrenomBebe" required />
          </div>
          <input id='submit-data' class="button" type="submit" value="inscrir" name="ok" />
        </form>
      </div>
    </div>
  </div>
