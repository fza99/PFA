...
{
 $chart_data .= "{ nom:'".$row["nom"]."', totalEnfant:".$row["totalEnfant"].", totalfille:".$row["totalfille"].", totalgarçons:".$row["totalg"]."}, ";
}
...
<html>
 ...
 <body>
  ...
  <div class="container" style="width:900px;">
   <h2 align="center">Ce graphe affiche </h2>
   <h3 align="center">Total des enfants , des filles , des graçons pour chaque enseignant</h3>   
   <br /><br />
   <div id="chart"></div>
  </div>
...
Morris.Bar({
 ...
 xkey:'nom',
 ykeys:['totalEnfant', 'totalfille', 'totalgarçon'],
 labels:['totalEnfant', 'totalfille', 'totalgarçon'],
 hideHover:'auto',
 stacked:true
});
</script>